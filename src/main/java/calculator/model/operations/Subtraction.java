 ...
 * Klasse t.b.v. aftrekken
 */

public class Subtraction extends OperatorElement implements Operator, BinaryOperator {

    public Subtraction(String operator) {
        super(operator);
    }

    @Override
    public BigDecimal execute(OperandElement left, OperandElement right) {
        return left.getOperand().subtract(right.getOperand());
    }
